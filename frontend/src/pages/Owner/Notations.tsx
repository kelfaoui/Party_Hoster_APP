  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-800">Notations de mes Salles</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-white rounded-xl shadow-sm p-6">
          ...
          <div className="text-gray-600">Total notations</div>
        </div>
        <div className="bg-white rounded-xl shadow-sm p-6">
          <div className="text-3xl font-bold text-green-500 mb-2">
            {notations.filter(n => n.note >= 4).length}
          </div>
          <div className="text-gray-600">Notes ≥ 4/5</div>
        </div>
        <div className="bg-white rounded-xl shadow-sm p-6">
          <div className="text-3xl font-bold text-blue-500 mb-2">
            {notations.length > 0 ? (notations.reduce((sum, n) => sum + n.note, 0) / notations.length).toFixed(1) : '0'}
          </div>
          <div className="text-gray-600">Note moyenne</div>
        </div>
        <div className="bg-white rounded-xl shadow-sm p-6">
          <div className="text-3xl font-bold text-red-500 mb-2">
            {notations.filter(n => n.note <= 2).length}
          </div>
          <div className="text-gray-600">Notes ≤ 2/5</div>
        </div>
      </div>
