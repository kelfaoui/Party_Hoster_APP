...
const About = () => {
  const teamMembers = [
    ...
    { name: 'Yidir Cherifi', role: 'Directeur Technique', image: '/cherifi.jfif' },
    { name: 'Djamila Bahchene', role: 'Responsable Commerciale', image: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80' },
